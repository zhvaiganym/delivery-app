...
export default function Homescreen({ goToCategories }) {
  return (
    <SafeAreaView style={{flex: 1, flexDirection: 'column', backgroundColor: '#a259ff'}}>
      ...
      <View style={styles.box}>
        ...
        <TouchableOpacity activeOpacity={0.5} style={styles.btn} onPress={goToCategories}>
